...
#include "WiseMultiCameraPeriodicApp_DPFPacket_m.h"
#include <vector>

class WiseMultiCameraPeriodicApp_DPFPacket : public WiseMultiCameraPeriodicApp_DPFPacket_Base {
public:
	std::vector<WiseUtils::Gmm::Component> gmm;

public:
	WiseMultiCameraPeriodicApp_DPFPacket(const char *name=NULL, int kind=0) : WiseMultiCameraPeriodicApp_DPFPacket_Base(name, kind) { }

	WiseMultiCameraPeriodicApp_DPFPacket(const WiseMultiCameraPeriodicApp_DPFPacket& other) : WiseMultiCameraPeriodicApp_DPFPacket_Base(other) {	gmm = other.gmm; }

	virtual inline WiseMultiCameraPeriodicApp_DPFPacket *dup() const {return new WiseMultiCameraPeriodicApp_DPFPacket(*this); }
