...
MacInteractionControl_type::MacInteractionControl_type()
{
    this->RSSI = 0;
    this->LQI = 0;
    this->source = 0;
...
class MacInteractionControl_typeDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
  public:
    MacInteractionControl_typeDescriptor();
    virtual ~MacInteractionControl_typeDescriptor();
...
Register_ClassDescriptor(MacInteractionControl_typeDescriptor);

MacInteractionControl_typeDescriptor::MacInteractionControl_typeDescriptor() : omnetpp::cClassDescriptor("MacInteractionControl_type", "")
{
    propertynames = nullptr;
}

MacInteractionControl_typeDescriptor::~MacInteractionControl_typeDescriptor()
{
    delete[] propertynames;
}

bool MacInteractionControl_typeDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<MacInteractionControl_type *>(obj)!=nullptr;
}

const char **MacInteractionControl_typeDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *MacInteractionControl_typeDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int MacInteractionControl_typeDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount() : 4;
}

unsigned int MacInteractionControl_typeDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *MacInteractionControl_typeDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MacInteractionControl_typeDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *MacInteractionControl_typeDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **MacInteractionControl_typeDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MacInteractionControl_typeDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MacInteractionControl_typeDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MacInteractionControl_type *pp = (MacInteractionControl_type *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string MacInteractionControl_typeDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->source);
        case 3: return ulong2string(pp->sequenceNumber);
        default: return "";
    }
}

bool MacInteractionControl_typeDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 2: pp->source = string2long(value); return true;
        case 3: pp->sequenceNumber = string2ulong(value); return true;
        default: return false;
    }
}

const char *MacInteractionControl_typeDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *MacInteractionControl_typeDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
MacPacket::MacPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
}
...
{
    this->MacInteractionControl = other.MacInteractionControl;
}

void MacPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->MacInteractionControl);
}

void MacPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->MacInteractionControl);
}

MacInteractionControl_type& MacPacket::getMacInteractionControl()
{
    return this->MacInteractionControl;
}

void MacPacket::setMacInteractionControl(const MacInteractionControl_type& MacInteractionControl)
{
    this->MacInteractionControl = MacInteractionControl;
}
...
int MacPacketDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0]=='M' && strcmp(fieldName, "MacInteractionControl")==0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string MacPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    MacPacket *pp = (MacPacket *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getMacInteractionControl(); return out.str();}
        default: return "";
    }
}
...
const char *MacPacketDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(MacInteractionControl_type));
        default: return nullptr;
    };
}
...
void *MacPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    MacPacket *pp = (MacPacket *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getMacInteractionControl()); break;
        default: return nullptr;
    }
}
...
MacControlMessage::MacControlMessage(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
